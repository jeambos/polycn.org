...
const DIMENSIONS = {
  comms: { name: "坦诚沟通", desc: "面对羞耻或恐惧时，依然能真实表达想法与感受的能力" },
  resilience: { name: "情绪调节", desc: "觉察自身情绪波动，并以建设性方式进行自我安抚与消化的能力" },
  ...
  decondition: { name: "去规训化", desc: "识别并剥离主流社会既定脚本的束缚，摆脱无意识的顺从" },
  resource: { name: "精力分配", desc: "调动精神能量以处理生活杂务、解决实际问题并维持秩序的能力" },
  autonomy: { name: "精神独立", desc: "建立内在评价体系，不依赖外界认可作为自我价值来源的稳固状态" }
};
...
const QUESTIONS = [
  ...
  { id: 5, dim: 'boundaries', text: "我清楚地知道自己的底线在哪里，并且在别人碰到我底线的时候，坚定地表达抗议。" },
  ...
  { id: 12, dim: 'decondition', text: "当我发现自己不是伴侣的“唯一”或“最爱”时，我往往会强烈地感觉到自己的价值被贬低了。", reverse: true },
  ...
  { id: 26, dim: 'bandwidth', text: "如果我需要在不同的关系中展现不同的自我（如在A面前像孩子，在B面前像导师），这让我感到丰富而非分裂。" },
  { id: 27, dim: 'decondition', text: "我能够理解并接受，伴侣可以从不同的人身上获得不同的满足（如智识、性、陪伴），我不需要满足他/她的一切。" },
  { id: 28, dim: 'decondition', text: "我潜意识里还是会隐隐约约觉得“一生一世一双人”的单偶制恋爱关系是最美好的爱。", reverse: true },
  { id: 29, dim: 'resource', text: "我能够比较清晰地评估自己未来一段的时间和精力余额，不会轻易许下无法兑现的承诺。" },
  ...
  { id: 39, dim: 'resource', text: "我知道更丰富的情感关系可能要比单偶制花费更高（更多的约会、交通成本等），这不会对我的经济带来负担" },
