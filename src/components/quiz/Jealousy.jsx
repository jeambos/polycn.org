...
const FEEDBACK_DATA = {
  competitive: {
    high: { desc: "你经常担心自己“不够好”。一旦伴侣夸奖别人，你就会害怕自己被比下去，从而失去伴侣的爱。", adv: "爱不是比赛，没有输赢。伴侣选择你，是因为你是独一无二的你，而不是因为你在各项指标上都打败了所有人。" },
    mid: { desc: "你偶尔会拿自己和别人比较，担心自己没有吸引力。", adv: "多关注那些只有你能给伴侣带来的独特价值。" },
    low: { desc: "你对自己很有自信，不怎么担心被别人取代。", adv: "保持这种自信，这是关系稳定的基石。" }
  },
  self_esteem: {
    high: { desc: "你很在意伴侣谈恋爱的“品味”。如果伴侣找了一个你觉得很差劲的人，你会觉得这也是在降低你的档次。", adv: "试着把“伴侣的行为”和“你的价值”分开。ta 喜欢谁是 ta 的自由，并不代表你也是那种档次。" },
    mid: { desc: "你有点自尊心过强，怕伴侣选的人比你差。", adv: "伴侣的决策可能有其理由，没有人拿你跟别人比，别太累。" },
    low: { desc: "你不太把自尊建立在伴侣的选择上。", adv: "继续保持~ 放过别人也放过自己，挺好的！" }
  },
  normative: {
    high: { desc: "你对非单偶行为有强烈的生理性抗拒。即使理智上想尝试，内心深处觉得这“不道德”或“脏”。", adv: "不要强迫自己“变得开放”。这种恶心感是你在保护自己。请慢下来，重新审视这种关系模式是否真的适合现在的你。" },
    mid: { desc: "看到一些出格的行为，你心里还是会咯噔一下。", adv: "问问自己，这些规矩是你想要的，还是别人教你的？" },
    low: { desc: "你心态很开放，不太受传统道德框架的束缚。", adv: "确保这种开放是出于真心，而不是为了迎合对方。" }
  },
  abandonment: {
    high: { desc: "你极度害怕被抛弃。只要伴侣的注意力不在你身上，你就会恐慌，觉得 ta 不爱你了。", adv: "试着练习“独处时的安全感”。同时，可以要求伴侣给你一些具体的保证（比如约定回家时间），这不丢人。" },
    mid: { desc: "伴侣不在的时候，你会觉得心里空落落的。", adv: "建立一些属于自己的爱好，让自己充实起来。" },
    low: { desc: "你有很好的安全感，信任伴侣会回来。", adv: "你的信任很珍贵，但也别忘了表达你的想念。" }
  },
  exclusion: {
    high: { desc: "你最受不了“不知道”。如果他们有秘密或你听不懂的梗，那种“局外人”的感觉比背叛更让你难受。", adv: "你可以坦诚告诉伴侣：“我不需要控制你，我只是想有一些参与感。”同时学会接受他们有属于自己的小世界。" },
    mid: { desc: "你不喜欢那种被蒙在鼓里的感觉。", adv: "和伴侣约定好信息同步的程度，减少猜疑。" },
    low: { desc: "你觉得每个人都有秘密很正常，不怎么纠结。", adv: "保持这种边界感，这会让关系更轻松。" }
  },
  territorial: {
    high: { desc: "你觉得属于你的时间、金钱或空间被抢走了。在你看来，爱就像一块有限的蛋糕，分给别人你就少了。", adv: "试着从“匮乏心态”转为“富足心态”。虽然时间有限，但爱是无限的。你可以要求一段完全属于你的“高质量独占时间”。" },
    mid: { desc: "你不喜欢别人动你的东西或占用你的时间。", adv: "明确划定哪些是你的绝对领域，哪些可以分享。" },
    low: { desc: "你很大方，不太计较资源的分配。", adv: "只要记得照顾好自己的需求，别委屈自己就行。" }
  },
  projective: {
    high: { desc: "你怀疑 ta，其实是因为你心里也有类似的想法。也许是你压抑了想玩的冲动，所以觉得 ta 肯定也在乱来。", adv: "对自己诚实一点，承认自己的欲望并不可耻。当你接纳了自己内心的“阴暗面”，你就不会总是戴着有色眼镜看 ta 了。" },
  ...
  if (!started) return (
    <QuizContainer>
      <WelcomeCard 
        title="嫉妒类型图谱"
        introList={[
          "嫉妒不是一种单一情绪，而是内心需求的信号灯。",
          "通过 10 个典型场景，探索你在亲密关系中的“嫉妒原型”。",
          "我们将分析你是更害怕“被抛弃”、更在意“输赢”，还是觉得“丢面子”。",
          "作答方式：每题分两步，先选“最痛点”，再选“共鸣点”。"
        ]}
        onStart={handleStart}
      />
      ...
      <QuizContainer>
        ...
        >
          {dominantItem ? (
            <>
              ...
              <div style={{ textAlign: 'left', padding: '0 0.5rem' }}>
                <p style={{ color: '#f4f4f5', fontSize: '1rem', lineHeight: 1.6, marginBottom: '1rem' }}>
                  <span style={{ color: '#fbbf24', fontWeight:'bold' }}>✦ 诊断：</span>
                  {dominantItem.content}
                </p>
                <p style={{ color: '#d4d4d8', fontSize: '0.95rem', lineHeight: 1.6 }}>
                  <span style={{ color: '#fbbf24', fontWeight:'bold' }}>✦ 建议：</span>
                  {dominantItem.advice}
                </p>
              </div>
            </>
            ...
            <>
              <div style={{ fontSize: '3rem', fontWeight: '900', color: '#fbbf24', marginBottom: '1rem' }}>平稳型</div>
              <div style={{ textAlign: 'left', color: '#d4d4d8' }}>
                您的嫉妒反应微弱，拥有极高的安全感。请确认这是“信任”而非“不在乎”，并继续保持这种独立豁达。
              </div>
            </>
          )}
        </ScoreCard>
        ...
        {/* 3. 详细分析 (使用 ResultAnalysis 智能折叠) */}
        <ResultAnalysis 
          title="全维度深度解析"
          threshold={5.0} // >=5 分算显著
